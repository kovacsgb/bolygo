...
! Local variable(s):
      ...
      PARAMETER (kR_H='kR_h2001.dat', !a file with Rosseland mean gas op &
                 kP_H='kP_h2001.dat') !a file with Planck mean gas opaci
      DIMENSION seq(71*71)
!
! Open input file:
      if (ross) then
...
! Data related to the evaporation temperatures of silicates, iron and ice:
      ...
      DATA tt(1,1),tt(2,1),tt(3,1),tt(4,1), &
          ...
          /1.090E+02,1.180E+02,1.290E+02,1.430E+02,  !Water ice evaporat &
           ...
           1.277E+03,1.408E+03,1.570E+03,1.774E+03/  !depending on densi
!                                                    !'ro'
...
! accretion disks:
          ...
          T(3) = 425.0D0  !evaporation temperature of refractory organic
...
!............................................................................
        ...
        dT(2) = 5.0D0  !an interval of T where vol. organics is evaporat
        dT(3) = 15.0D0  !an interval of T where ref. organics is evapora
